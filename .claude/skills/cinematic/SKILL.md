...
This repo (`karts`) contains short film projects under `project/`.
Point this at the project you are working on — see its plan file.
...
and research materials in `project/plan/` and `project/research/`.
